...
//    fun createNavigationRoute(mediaType: com.maximillianleonov.cinemax.core.model.MediaType.Details) =
//        "$route/${mediaType.mediaId}/${mediaType.mediaType}"
//
//    fun fromSavedStateHandle(savedStateHandle: SavedStateHandle) = com.maximillianleonov.cinemax.core.model.MediaType.Details.from(
